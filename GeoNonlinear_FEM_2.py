...
class GNLexamples:
    ...
    @classmethod
    def deepArch(cls, R: float = 100, phi0: float = 215, F: float = 1E6, b: float = 0.01, h: float = 0.2, n: int = 40):
        """
...
class FEMsolve:
    ...
    @classmethod
    def arcL(cls, mesh, numInc: int, maxIter: int = 15, Lambda0: float = 0.1, maxErr: float = 1E-6, elType: Callable = B2D_SR):
        """
